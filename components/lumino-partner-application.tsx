        ...
        <Card>
          ...
          <CardContent className="prose custom-prose dark:prose-invert max-w-none space-y-4">
            ...
            <div className="space-y-4 py-4">
              ...
              <p className="text-sm">
                Please acknowledge receipt and understanding of the above-stated compliance and code of ethics
                agreement, and return with the Lumino Partner Agreement:
              </p>
              <div className="space-y-2">
                ...
                {errors.codeOfConductSignature && (
                  <p className="text-red-500 text-sm">{errors.codeOfConductSignature}</p>
                )}
              </div>
              <div className="space-y-2">
        ...
        <CardContent className="prose custom-prose dark:prose-invert max-w-none space-y-4">
          <div className="pb-4">
            <p>
              ...
              by Lumino and in advance of their use. The use of the Internet for marketing products and services is
              subject to the same policies and procedures applicable to written or printed material. Please note that to
              help all of our partners maintain compliance with the Visa/MasterCard regulations regarding the
              advertisement of card processing services on the Internet, all of the Visa/MasterCard regulations must be
              met in addition to the following:
            </p>
            <p>
              The following endorsement statement must appear at the bottom of the website's homepage, "about us" page
              and any website pages displaying Visa/MasterCard logos and/or text or advertising for Merchant services.
              *All Merchant Accounts are referred to and processing services are provided by Lumino. Credit card logos
              cannot appear on your website unless you accept those credit cards as a form of payment, and may not
              appear on any page advertising for Merchant processing services unless the above requirement is met.
            </p>
            <p>
            ...
            <p>
              ...
              Prohibitions on some forms of advertising, notably, but not limited to, fax advertising (entirely
              prohibited in the US), email solicitation, and automated dialers/announcing devices ("ADAD'). While the
              above-mentioned Visa/MasterCard regulations still apply, Lumino has an obligation to notify our partners
              of the importance of familiarizing themselves with the various laws surrounding the use of automated
              dialers/announcing devices. These laws vary in scope and severity based on jurisdictional differences.
            </p>
          </div>
          <p>
          ...
          <p>
            ADADs are regulated federally for calls to consumers. However, there are no federal restrictions on their
            use for commercial calls. Furthermore, many states have enacted regulatory frameworks that seek both to
            protect residents (often businesses and consumers) from the annoyance of ADAD calls and to prevent
            ADAD-generated calls from impeding telephone service.
          </p>
          <br />
          <div className="pt-8">
            ...
            <p>
              ...
              according to criminal statutes or civil regulations): Arkansas (criminal), Maryland (criminal),
              Mississippi (civil), North Carolina (civil), Washington (civil), and Wyoming (criminal).
            </p>
            <p>
              The following states allow business-to-business ADAD calls without restrictions: Alabama, Alaska, Arizona,
              Connecticut, Delaware, Florida, Georgia, Hawaii, Kansas, Louisiana, Missouri, Ohio, Oregon, South
              Carolina, South Dakota, Texas, Vermont, Virginia, and West Virginia.
            </p>
            <p>
              ...
              period after hang-up for the call to be disconnected (the range tends to be between five and thirty
              seconds) and mandate that the name and contact information of the business for whom the call is being made
              be provided at the start of the call. The states with some combination of these fairly manageable ADAD
            ...
            <p>
              Several states have imposed fairly onerous restrictions upon those businesses that attempt to solicit
              sales through the use of business-to-business ADAD calls. Some of these states require that live operators
              introduce the recorded call, that ADAD calls can only be made to businesses with whom the caller has a
              prior relationship or has otherwise consented to receive ADAD calls, and that the ADAD equipment only
              operates while it is attended.
            </p>
            <p>
            ...
            <p>
              ...
              <br />
              <br />
              Express consent is required to be given by the recipient before ADAD calls can be made to businesses in
              the following states: Michigan, Minnesota, Montana, and Wisconsin.
              <br />
              <br />
            ...
            <p>
              ...
              <br />
              <br />
              You must make your records involving products and services available to Lumino for general auditing
              purposes or to enable Lumino to respond to any regulatory or administrative action against Lumino or
              yourself.
              <br />
              <br />
            ...
            <p>
              ...
              Lumino. A breach of confidentiality can have serious consequences. Therefore, you must safeguard all
              confidential Merchant and Lumino information and only provide access to individuals who have a legitimate
              right to it. You are responsible for maintaining the security of all confidential information in your
              possession, which shall be held at all times in strict confidence, and you hereby agree to indemnify,
              defend, and hold harmless Lumino from any financial, reputational, or other damage that results from your
              breach of this paragraph. The confidentiality obligations contained herein are in addition to, and not in
              lieu of, similar or greater obligations contained in the Partner Agreement or elsewhere agreed between you
              and Lumino.
            </p>
            ...
            <p>
              ...
              products and services to its Merchants and Partners. In order to protect the solid reputation of Lumino
              and its Partners, appropriate action (verbal or written, contract termination or prosecution) will be
              taken by Lumino on all known violations of its policies and procedures. Lumino requires all Partners to
              abide by its policies and procedures. Due to frequent law changes, these compliances are subject to
              change. Partners will be responsible for being up-to-date with current regulations.
            </p>
          </div>
          <p>
